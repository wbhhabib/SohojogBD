        ...
        <>
            ...
            <main className="min-h-screen" style={{ background: 'linear-gradient(180deg, #fffbeb 0%, #f9fafb 120px)' }}>
                ...
                <section className="max-w-7xl mx-auto px-4 -mt-2 mb-6">
                    <div className="flex items-center gap-3 rounded-2xl border border-dashed border-amber-200 bg-white px-5 py-4">
                        <div className="w-9 h-9 rounded-full flex items-center justify-center shrink-0 bg-amber-50">
                            <GraduationCap size={16} className="text-amber-600" />
                        </div>
                        <p className="text-sm text-gray-600">
                            <span className="font-semibold text-gray-900">Free skill courses</span> from
                ...
                <section className="max-w-7xl mx-auto px-4 py-8">
                    ...
                    <div className="flex items-center justify-between mb-5">
                        ...
                        <a href="/grow-together/my" className="flex items-center gap-1.5 text-xs font-semibold text-amber-600 hover:text-amber-700">
                            <Users size={13} />
                            My pools &amp; interests
                        </a>
                    </div>
