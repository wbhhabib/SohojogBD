    ...
    <ErrorBoundary>
      <DashboardLayout role="admin">
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
          ...
          <StatCard label="Total Users" value={totalUsers.toLocaleString()} sub={`${stats?.users.verified ?? 0} verified`} icon={<Users className="w-5 h-5 text-purple-600" />} iconBg="bg-purple-50" trend="up" loading={statsLoading} />
        </div>
